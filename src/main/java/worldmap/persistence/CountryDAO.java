...
public class CountryDAO extends BaseDAO {
    ...
    public List<Country> find10LargestSurfaces() {
        return selectCountries("SELECT * FROM country ORDER BY surface DESC LIMIT 10");
    }
    ...
    public Country save(Country country) {
        ...
        try (Connection con = super.getConnection()) {
            ...
            statement.executeQuery("INSERT INTO country (code,name,continent,region,population,surface,governmentForm) VALUES(" + code + "," + name + "," + continent + "," + region+ "," + population+ "," + surface+ "," + governmentForm + ")");
